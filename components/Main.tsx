...
const Main = () => {
  ...
  return (
    <div className=' grow shrink-0 p-3 w-full max-w-100 lg:max-w-[1024px]'>
        
        {/* <BackgroundCircles className=''/> */}
        <UpButton className='hover:text-white transition fixed right-5 z-50 bottom-10 p-4 bg-lime-500 rounded-full text-black'/>
                        ...
                        <ul className="flex flex-col justify-between h-full">
                            <li className="" title='My birth date'>
                                ...
                                className="flex gap-2 items-center w-fit  transition rounded-xl p-2 hover:bg-gray-600">
                                    <GlobalSvgSelector id='calendar' className='text-white bg-lime-500 p-1 rounded-full max-h-[20px] max-w-[20px]'/>
                                    11 July 2005</a>
                            </li>
                            <li className="" title='Phone number'>
                                <a href="tel:+380936990092" 
                                className="flex gap-2 items-center w-fit  transition rounded-xl p-2 hover:bg-gray-600"> 
                                <GlobalSvgSelector className='text-white bg-lime-500 p-1 rounded-full max-h-[20px] max-w-[20px]' id='phone' />
                                Call me</a>
                            </li>
                            <li className="" title='Write me'>
                                <a href="email:pashalopatuk@gmail.com" 
                                className="flex gap-2 items-center w-fit  transition rounded-xl p-2 hover:bg-gray-600">
                                <GlobalSvgSelector className=' bg-lime-500 p-1 rounded-full max-h-[20px] max-w-[20px]' id='email'/>    
                                My email</a>
                            </li>
                            <li className="" title='My location'>
                                ...
                                className="flex gap-2 items-center w-fit  transition rounded-xl p-2 hover:bg-gray-600">
                                <GlobalSvgSelector id='gps' className=' bg-lime-500 p-1 rounded-full max-h-[20px] max-w-[20px]'/>    
                                Lutsk, Ukraine</a>
                            </li>
                        </ul>
                    </div>
